...
import {
    ...
    create,
    // component
    NButton, NDatePicker, NSpace, NCard, NCollapse, NMenu, NTimeline, NTimelineItem, NDataTable
  } from 'naive-ui'
...
const naive = create({
    components: [NButton, NDatePicker, NSpace, NCard, NCollapse, NMenu, NTimeline, NTimelineItem, NDataTable ]
  })
